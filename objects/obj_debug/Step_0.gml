...
if(obj_input.keys.f2.press) { interface.anchor.set_right_position(8); show_debug_message(interface) }
if(obj_input.keys.f3.press) { interface.anchor.set_top_position(8); show_debug_message(interface) }
